 ...
 * The sclass needs to have one constructor with parameters width and length both of type double and it
 *  * needs to initialize the field.
 *
...
public class Rectangle {
    ...
    double width;
    double length;
//class have one constructor with parameters width and length both of type double and it
 //needs to initialize the field
